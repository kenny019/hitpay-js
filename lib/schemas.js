...
exports.refundPaymentSuccessSchema = exports.refundPaymentSchema = exports.createPaymentSuccessSchema = exports.createPaymentParamsSchema = exports.hitpayConstructorSchema = void 0;
...
exports.refundPaymentSchema = zod_1.default.object({
    amount: zod_1.default.number(),
    payment_id: zod_1.default.string(),
    webhook: zod_1.default.string().optional(),
    send_email: zod_1.default.boolean().optional(),
    email: zod_1.default.string().optional(),
});
exports.refundPaymentSuccessSchema = zod_1.default.object({
    id: zod_1.default.string(),
    payment_id: zod_1.default.string(),
    amount_refunded: zod_1.default.number(),
    total_amount: zod_1.default.number(),
    currency: zod_1.default.string(),
    status: zod_1.default.string(),
    payment_method: zod_1.default.string(),
    created_at: zod_1.default.string(),
});
